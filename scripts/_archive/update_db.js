...
var JSON_PATH = 'public/data/questions.json';
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var data, updatedCount, _i, data_1, q;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = JSON.parse(fs_1.default.readFileSync(JSON_PATH, 'utf8'));
                    updatedCount = 0;
                    _i = 0, data_1 = data;
                    _a.label = 1;
                case 1:
                    ...
                    q = data_1[_i];
                    if (!q.id) return [3 /*break*/, 3];
                    return [4 /*yield*/, prisma.question.update({
                            where: { id: q.id },
                            data: {
